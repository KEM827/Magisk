...
- move your origional recovery.img from the adb directory,  or delete or rename the file. ie recoveryStock.img
...
- Flash the patched boot/recovery image to your device.<br>
      ...
      `fastboot flash boot /pc-filepath/recovery.img` or <br>
      `fastboot flash recovery /pc-filepath/recovery.img` if flashing a recovery image
             where /pc-filepath/ is the directory pathway on your pc where the magisk_patched.img file was renamed to recovery.img
- Reboot and voila!
